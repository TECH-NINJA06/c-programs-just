...
int main() {
    ...
    cout<<"|"<<setw(13)<<left<<"Closing Kms.:"<<setw(5)<<left<<closingKms<<left<<setw(15)<<right<<"Total Kms. "<<left<<setw(5)<<closingKms-openingKms<< setw(18)<<right<<"Closing Time "<<setw(10)<<left<<closingTime <<setw(11)<<right<<"|"<<endl;
